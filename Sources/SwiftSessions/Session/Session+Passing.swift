...
extension Session {
    ...
    public static func send<A, B, C>(_ payload: A, on endpoint: Endpoint<(A, Endpoint<B, C>), Empty>) async -> Endpoint<C, B> {
    ...
    public static func recv<A, B, C>(from endpoint: Endpoint<Empty, (A, Endpoint<B, C>)>) async -> (A, Endpoint<B, C>) {
    ...
    public static func offer<A, B, C, D>(_ endpoint: Endpoint<Empty, Or<Endpoint<A, B>, Endpoint<C, D>>>) async -> Or<Endpoint<A, B>, Endpoint<C, D>> {
    ...
    public static func left<A, B, C, D>(_ endpoint: Endpoint<Or<Endpoint<A, B>, Endpoint<C, D>>, Empty>) async -> Endpoint<B, A> {
    ...
    public static func right<A, B, C, D>(_ endpoint: Endpoint<Or<Endpoint<A, B>, Endpoint<C, D>>, Empty>) async -> Endpoint<D, C> {
